...
```bash
# 词典位置: {baseDir}/字幕/词典.txt（脚本自动加载）

bash "{baseDir}/剪口播/scripts/volcengine_transcribe.sh" "https://o.uguu.se/xxxxx.mp3"
```
...
```bash
cd 字幕目录/
node "{baseDir}/字幕/scripts/subtitle_server.js" 8898 "video.mp4"
```
